...
class VideoDepthAnythingDepthModel(DepthEstimationModel):
    ...
    def __init__(self, model: str = "vitl", input_size: int = 518, device: str | torch.device = "cuda") -> None:
        super().__init__()
    ...
    def estimate(self, src: DepthEstimationInput) -> DepthEstimationResult:
        ...
        depths = self.model.infer_video_depth(
            frame_list, input_size=self.input_size, device=self.device, fp32=self.use_fp32
        )  # [T, H, W]
