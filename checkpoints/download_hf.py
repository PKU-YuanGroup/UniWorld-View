...
def main() -> None:
    ...
    # NOTE: Wan-AI/Wan2.1-VACE-14B-diffusers is NOT downloaded here.
    # Place it manually under checkpoints/Wan2.1-VACE-14B-diffusers (separate download).
    ...
    # Main model weights (UniView only; Wan2.1-VACE is downloaded separately)
